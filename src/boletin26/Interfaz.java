...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldNome.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextFieldNome.setPreferredSize(new java.awt.Dimension(120, 25));

        jTextFieldApelido.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextFieldApelido.setPreferredSize(new java.awt.Dimension(120, 25));

        jComboBoxCurso.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DAM1", "DAM2", "ASIR1", "ASIR2" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        fila[0] = jTextFieldNome.getText();
        fila[1] = jTextFieldApelido.getText();
        fila[2] = jComboBoxCurso.getSelectedItem();
        tabla.addRow(fila);
